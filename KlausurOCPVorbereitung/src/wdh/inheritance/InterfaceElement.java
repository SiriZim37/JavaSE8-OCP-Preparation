...
//	final void m11111();							// cf : only public, abstract, default, static 
	...
	static int K3 = 3;								// implcit : public final	
	final int K4 = 4;								// implcit : public static	
	public int K5 = 5;								// implcit : static	final
...
class MyTestClass implements MyTestInterface{
	...
	void go() {
		...
		System.out.println(m.K1);
		System.out.println(this.K2);
		System.out.println(K3);
		System.out.println(MyTestInterface.K4);
//		m.m3(); cf 
		MyTestInterface.super.m2();
	}
}


public class InterfaceElement extends MyTestClass {
...
//		MyTestInterface.super.m2();  >> cf but wenn implement interface can call super
		super.m2();  // aus dem Interface
		this.m2();   // aus dem Interface
		this.m1();
	}
}
