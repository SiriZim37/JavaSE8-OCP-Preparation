...
public class EncapsulationConcept {
	...
	/*
	 Duplicate 1z0-808 Question 184
		...
		A. Allows a class implementation to change without changing the clients
			>> the clients = the other class
			>> สามารถเปลี่ยนแปลง implement ภายในได้ โดยที่ Class ที่มาเรียกใช้ไม่ต้องแก้ไข
			
		B. Protects confidential data from leaking out of the objects
			>> ป้องกัน object อื่นมาแก้ไข
